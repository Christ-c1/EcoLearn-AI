...
class Learning_pathsService:
    ...
    async def create(self, data: Dict[str, Any], user_id: Optional[int] = None) -> Optional[Learning_paths]:
    ...
    async def get_by_id(self, obj_id: int, user_id: Optional[int] = None) -> Optional[Learning_paths]:
    ...
    async def update(self, obj_id: int, update_data: Dict[str, Any], user_id: Optional[int] = None) -> Optional[Learning_paths]:
